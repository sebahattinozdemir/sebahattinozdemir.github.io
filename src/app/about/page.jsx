            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="p-3 text-sm italic">
                    I led web development, offering expertise in JavaScript and Typescript
                    frameworks.
                  </div>
                  {/* JOB DATE */}
                  ...
                  <a target="_blank" _blank href="https://www.gevernova.com/">
                      Ge Vernova
                  </a>
                  </div>
                </div>
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    I spearheaded Angular-based application development,
                  ...
                  {/* JOB COMPANY */}
                  <div className="p-1 rounded bg-white text-sm font-semibold w-fit">
                    <a target="_blank" _blank href="https://turkish.turkpages.com/">
                      Turkpages
                    </a>
                  </div>
                </div>   
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    Defense Industry Project , Pure Java 8
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2018 - 2019
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    I made my compulsory intern, improved my coding skills here.
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-400 text-sm font-semibold">
                    2018 - 2018
                  ...
                  {/* JOB COMPANY */}
                  <div className="p-1 rounded bg-white text-sm font-semibold w-fit">
                    <a target="_blank" _blank href="https://www.gbgplc.com/en/">
                      GBG PLC.
                    </a>
                  </div>
                </div>   
